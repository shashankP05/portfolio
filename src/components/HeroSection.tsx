    ...
    >
      ...
      <div className="section-container flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="flex flex-col max-w-xl space-y-6 text-center lg:text-left">
          ...
          >
            Web Developer & ML Engineering Student
          </motion.p>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="space-y-2 font-mono text-sm">
                <div className="text-gray-500">{"// AI Enthusiast"}</div>
                <div>
                ...
                >
                  ...
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-green-600">'Shashank Poojary'</span>
                  <span className="text-gray-500">,</span>
                </motion.div>
                ...
                >
                  ...
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-orange-500">[</span>
                  <span className="text-green-600">'ML Engineer'</span>
                  <span className="text-gray-500">,</span>{" "}
